...
export default function CreatePlaylistButton({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-[4/1.2] sm:aspect-[4/1] rounded-3xl bg-[#2fc355] border-4 border-[#0a631e] shadow-none ring-0 ring-transparent transition-all duration-300 ease-out group-hover:scale-[1.02] group-focus:scale-[1.02] group-focus-visible:scale-[1.02] group-hover:shadow-[8px_8px_0px_0px_#0a631e] group-focus:shadow-[8px_8px_0px_0px_#0a631e] group-focus-visible:shadow-[8px_8px_0px_0px_#0a631e] group-hover:ring-6 group-focus:ring-6 group-focus-visible:ring-6 group-hover:ring-[#2fc355]/60 group-focus:ring-[#2fc355]/60 group-focus-visible:ring-[#2fc355]/60 group-hover:bg-[#34d15d] group-focus:bg-[#34d15d] group-focus-visible:bg-[#34d15d] group-active:scale-[0.99] group-active:translate-x-1 group-active:translate-y-1 overflow-visible flex items-center justify-center">
